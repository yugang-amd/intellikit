...
ROCm MCP includes the following MCP servers.
...
Exposes system topology and device information using the `rocminfo` utility.

## Installation

Run the following commands from the `rocm_mcp` directory.
